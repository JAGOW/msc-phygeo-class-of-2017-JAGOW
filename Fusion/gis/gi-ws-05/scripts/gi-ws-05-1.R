...
system(paste0(Fusion, "clipdata.exe"," /class:2 ", pd_gi_input, "lidar_files.txt ", pd_gi_output, "classified_GroundPts.las ", ext)) 
...
system(paste0(Fusion, "clipdata.exe", " /height /dtm:",mainDir, outDir,"caldern_GridSurf.dtm ", mainDir, inDir, "lidar_files.txt ", mainDir, outDir, "caldern_normalized_point_cloud_LIDAR.las ", ext)) 

# create slice between zmin: 0 and zmax:2# 
system(paste0(Fusion, "clipdata.exe"," /zmin:0 /zmax:2 ", mainDir, outDir, "caldern_normalized_point_cloud_LIDAR.las ", mainDir, outDir, "caldern_normalized_point_cloud_LIDAR_zmin0_zmax2.las ", ext))
